...
public class GoalActivity2 {
    ...
    public void simpleLogin() {
        ...
        //driver.findElementById("com.android.chrome:id/infobar_close_button").click();
        driver.findElement(MobileBy.xpath("//android.widget.Button[contains(@text,'Get Started!')]")).click();
        //Scroll the element and click it
    ...
    public void inValidCredentials() {
        ...
        System.out.println("The invalid credentials message is: "+ inv);
